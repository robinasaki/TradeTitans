...
public class PortfolioTest {
    ...
    @Test
    public void testTradeTransactionCreation() {
        /**
         * to test github issue #65:
         * java: incompatible types: entity.Tradeable cannot be converted to double
         */
        setup();
        TradeTransaction test = new TradeTransaction(usd, outsidePortfolio.toString(), 5000, 0, 0);
        System.out.println(test.getAmountIn());
    }
